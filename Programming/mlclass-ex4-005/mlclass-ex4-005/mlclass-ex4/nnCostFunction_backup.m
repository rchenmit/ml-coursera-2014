function [J grad grad2] = nnCostFunction(nn_params, ...
                                   input_layer_size, ...
                                   hidden_layer_size, ...
                                   num_labels, ...
                                   X, y, lambda)
...
%     %1. perform feedforward pass -- we did this already in Part 1!
    ...
    Delta2(:,2:end) = Delta2(:,2:end) + d3(t,:)'*a2(t,2:end);
    %Delta1 = Delta1 + d2(t,2:end)'*a1(t,:);
    Delta1(:,2:end) = Delta1(:,2:end) + d2(t,2:end)'*a1(t,2:end);
...
Theta1_grad1 = 1/m * Theta1_grad1;
Theta2_grad1 = 1/m * Theta2_grad1;
...
grad2 = [Theta1_grad1(:) ; Theta2_grad1(:)];
